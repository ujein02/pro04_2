...
<style>
ul { list-style:none; }
.orbit-slide{height:700px;}
.orbit-container {height:700px;}
.small-12 cell > label{font-size:25px;}
#logo { display:block; width:100px; height:50px; background-image:url("${path0 }/data/logo.png"); background-color:white;
